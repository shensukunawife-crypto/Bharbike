...
router.get("/bikes/lock-status/:requestId", requirePermission("manage_bikes"), adminController.adminGetLockUnlockStatus);
...
router.get("/notifications", requirePermission("manage_notifications"), adminController.notificationsPage);
router.get("/notifications/users", requirePermission("manage_notifications"), adminController.getNotificationUsers);
router.post("/notifications/send", requirePermission("manage_notifications"), adminController.sendNotification);
...
router.post("/chatbot", requirePermission("manage_settings"), adminController.chatBot);
